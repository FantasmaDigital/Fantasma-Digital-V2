...
const EngHUD = () => {
   return (
      <div className="min-h-screen bg-[#040406] text-slate-300 font-display animate-fadeIn">
         <SEO
            title="Artesanía Digital | Portal de Ingeniería"
            description="Desplegamos infraestructuras de negocio con artesanía digital y poder corporativo. Ingeniería de software de misión crítica."
         />
