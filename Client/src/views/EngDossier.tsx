...
const EngDossier = () => {
   ...
   return (
      <div className="min-h-screen bg-[#0a0a0c] text-gray-100 pt-10 lg:pt-32 pb-20 px-6 lg:px-20 max-w-[1800px] mx-auto animate-fadeIn" style={{ backgroundImage: 'radial-gradient(rgba(250, 177, 110, 0.05) 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
         <SEO
            title="Repositorio de Proyectos | Ingeniería Alpha"
            description="Explora los últimos proyectos desplegados por Fantasma Digital. Dossiers detallados de arquitectura, diseño y desarrollo de software de élite."
         />
         {/* Title Section */}
         ...
         {/* Project Grid */}
         <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10">
