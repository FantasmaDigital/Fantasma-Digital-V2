...
const Intake = () => {
   ...
   const handleInputChange = (field: 'projectId' | 'email' | 'message', value: string) => {
   ...
   return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 lg:p-12 relative animate-fadeIn">
               ...
               <div className="space-y-10">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                           ...
                           <input
                              ...
                              placeholder="gerencia@fantasmadigital.dev"
                              className="bg-transparent border border-white/20 focus:border-primary rounded p-4 font-mono text-sm text-white placeholder:text-white/10 outline-none transition-colors"
                           />
                        </div>
                     </div>
                  ...
                  <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/10">
                     ...
                     <button
                        ...
                        disabled={!formData.projectId || !formData.email}
                        className="w-full sm:w-auto px-10 py-4 bg-primary text-background font-bold uppercase tracking-widest text-sm rounded hover:bg-white disabled:opacity-30 disabled:hover:bg-primary transition-all shadow-lg hover:shadow-primary/20"
                     >
