      ...
      <div className="relative animate-fadeIn">
         ...
         <section className="relative h-[90vh] flex flex-col items-center justify-center overflow-hidden">
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none select-none opacity-[0.02] overflow-hidden" aria-hidden="true">
               <h1
                  className="font-display font-black text-[15vw] md:text-[18vw] leading-none text-white will-change-transform transition-transform duration-75 ease-out"
                  style={{ transform: `translateY(${scrollY * 0.5}px)` }}
               >
                  ESCALABLE
               </h1>
               <h1
                  className="font-display font-black text-[18vw] md:text-[22vw] leading-none text-white will-change-transform transition-transform duration-75 ease-out"
            ...
            >
               ...
               <h2 className="font-display font-black text-[10vw] md:text-8xl leading-none text-white mb-8 tracking-tighter min-h-[1em]" aria-label="Software">
                  {displayText}
               ...
               <div className="flex items-center justify-center gap-4 font-mono text-[10px] tracking-[0.3em] uppercase text-white/40">
                  <img src="/logo.png" alt="" className="w-6 h-6 opacity-20 mr-2 grayscale brightness-200" />
